...
This section is for upserting `entities` that contains generated `custom_id` in response. The `custom_id` is use for retrieving `entities` and other details at [**Retrieve Matches**](../retrieve-matches/retrieving-entities.md) section.
